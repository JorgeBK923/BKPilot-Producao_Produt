---
id: gerar-cenarios-mobile-tv
description: "Gera cenarios de teste para app Android TV a partir do mapa de exploracao."
name: "Cenarios Android TV"
type: interactive
language: pt-BR
...
inputs:
  ...
  - name: modulo
    required: false
    description: "Gera cenarios apenas para o modulo informado"
  - name: requisitos
    required: false
    description: "Documento fonte opcional (PDF, DOCX, Markdown, TXT)"
targets:
  claude:
    supported: true
  opencode:
